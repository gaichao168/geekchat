...
```bash
php artisan admin:install //生成后台管理员账号 admin:admin
php artisan db:seed --class=WechatUser //生成微信测试用户
php artisan db:seed --class=UpVipConfigSeeder //生成会员套餐
php artisan db:seed --class=ShareSeeder //知识分享文章
php artisan serve
npm run dev
```
