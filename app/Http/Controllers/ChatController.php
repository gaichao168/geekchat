...
class ChatController extends Controller
{
    ...
    public function audio(Request $request): JsonResponse
    {
        ...
        $messages = $request->session()->get('messages', [
            ['role' => 'system', 'content' => 'You are WoChat - A chatbot that can understand text, voice, draw image and translate. Answer as concisely as possible. Make Mandarin Chinese the primary language']
        ]);
