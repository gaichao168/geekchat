<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label class="dark:text-white" for="email" :value="__('邮箱')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="dark:text-white" for="password" :value="__('密码')" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center dark:text-white">
                ...
                <span class="ml-2 text-sm text-gray-600 dark:text-white">{{ __('记住我') }}</span>
            </label>
        </div>
