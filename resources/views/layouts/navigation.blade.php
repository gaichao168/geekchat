<div class="border-b border-teal-400  dark:bg-gray-700">
    <nav class="container mx-auto flex justify-between items-center">
        ...
        <nav class="flex space-x-4 justify-start items-center">
            ...
            <a href="https://prompting.wobcw.com" title="学习AI提示" target="_blank" class="dark:text-white text-black py-3 px-4 hover:text-teal-500 hover:bg-gray-500">学习提示</a>
            <a href="/shares" title="知识科普" class="dark:text-white text-black py-3 px-4 hover:text-teal-500 hover:bg-gray-500">知识科普</a>
            <a href="{{asset('/images/wechat_code.jpg')}}" class="dark:text-white text-black py-3 px-4 hover:text-teal-500 hover:bg-gray-500">联系我们</a>
        </nav>
{{--        @if (Route::has('login'))--}}
{{--            <div class="">--}}
{{--                @auth--}}
